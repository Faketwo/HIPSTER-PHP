...
<table class="search">
    <tr>
        <td>
            ...
            <label for="search_text">關鍵字(名稱、地址):</label>
...
<form name="myForm" entype= "multipart/form-data" method="POST" action="delete.php">
    <table class="table table-striped border_b">
        ...
        <tfoot>
            ...
            <?php if($total > 0) { ?>
            <tr>
                <td class="border_b" colspan="11"><input class="btn btn-mainColor btn-sm" type="submit" name="smb" value="刪除" onclick="return confirm('是否確定刪除');"></td>
            </tr>
            <?php } ?>

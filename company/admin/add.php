...
//SQL 敘述
$sql = "INSERT INTO `product` (`productName`, `productImg`, `productPrice`, `productAmount`,`productAddress`,`productEndingDate`,`categoryId`,`companyId`) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
//繫結用陣列
$arrParam = [
    $_POST['productName'],
...
if($_POST['productName'] == ""){
    ...
    $answer = "新增資料失敗(未填入商品名稱)";
    equire_once('../loading.php');
    // echo json_encode($objResponse, JSON_UNESCAPED_UNICODE);
    exit();
}else {

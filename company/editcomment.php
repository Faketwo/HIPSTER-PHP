        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="border">
                    <input class="btn-mainColor btn btn-sm " type="button" onclick="location.href='./comments.php?id=<?php echo $arr[$i]['id']; ?>'" value="編輯回覆">
                    <!-- <input type="button" onclick="if(confirm('是否確認刪除這些資料')) location.href='./comment_delete.php?id=<?php echo $arr[$i]['id']; ?>'"  value="單筆刪除" > -->
                    </td>
                    
                </tr>
            <?php
                }echo ' <tr><td class="my-3">共'.count($arr).'筆資料</td><td colspan="8"></td></td></tr>';
            }else{
            ?>
                <tr>

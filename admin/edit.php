    ...
    <table class="table table-striped border_b">
        <thead class="thead-mainColor">
            <tr>
                ...
                <th class="border">商品主圖預覽</th>
                <th class="border">商品價格</th>
                <th class="border w120px">商品數量</th>
                <th class="border w300px">商品地址</th>
                <th class="border">商品種類</th>
                <th class="border">商品結束時間</th>
            </tr>
        </thead>
        <tbody>
        ...
        ?>
            ...
            <tr>
                ...
                <td colspan="6" >
                    <textarea class="w90 h500px" style="resize:none" name="productContent" ><?php echo $arr['productContent']; ?></textarea>
                </td>
            </tr>
            ...
            <tfoot>
                <tr>
                    <td class="border_b" colspan="7"><input type="submit" class="btn btn-mainColor btn-sm" name="smb" value="更新"></td>
                </tr>
            </tfoot>
            </table>

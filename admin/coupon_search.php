        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="companyborder">
                        <input class="btn btn-mainColor btn-sm"  type="button" value="編輯" onclick="location.href='./editCoupon.php?editId=<?= $arr[$i]['couponId'] ?>'">
                        <input class="btn btn-mainColor btn-sm"  type="button" value="刪除" onclick="location.href='./deleteCoupon.php?deleteCouponId=<?= $arr[$i]['couponId'] ?>'">
                    </td>
                </tr>
            <?php
                }

...
$sqlTotal = "SELECT count(1) FROM `rel_member_coupon`";
...
<form class="myForm" name="myForm" method="POST" action="deleteRelId.php">
    <table class="border  table table-striped border_article">
        ...
        <tfoot>
            <tr>
                ...
                <?php
                    if($page > 1){
                        echo '<a class="btn btn-mainColor btn-sm" href="couponRel.php?page='.($page-1).'">上一頁</a>';
                    }
                ...
                <?php } 
                    if($page < $totalPages){
                        echo '<a class="btn btn-mainColor btn-sm" href="couponRel.php?page='.($page+1).'">下一頁</a>　';
                    }                
                ?>
                </td>
            </tr>
    ...
    <input type="submit" name="smb" value="多筆刪除" class="btn btn-mainColor btn-sm" onclick="return confirm('是否確認刪除這些資料');">
</form>
<script>

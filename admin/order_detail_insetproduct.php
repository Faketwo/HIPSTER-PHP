...
<a type="button" class="btn btn-secondary btn-sm mb-3"href="./orderdetail.php?orderId=<?php echo $_GET['orderId']?>">回到訂單明細</a>
<form name="myForm" class="myForm"method="POST" action="./order_addproduct.php">
